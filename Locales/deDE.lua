...
L.mindControlInc = "Gedankenkontrolle kommt, aufpassen!"
L.threatWipeSpawnAdd = "Bedrohung schwindet- es spawnen Adds!"
L.killOrbsFast = "Orbs schnell töten!"
L.sharedCleave = "gemeinsames Spalten - Stell dich vor den Boss!"
L.finished = "%s beendet!"
L.dispelBoss = "Boss dispellen!"
L.watchOut = "%s erschienen, Aufpassen!"
L.changeTank = "%s on %s, Tank wechseln (Spotten)!"
L.damageMark = "Markierung auf dir, Schaden einstellen!"
L.runToLink = "Renne zum verbundenem Mitspieler!"
